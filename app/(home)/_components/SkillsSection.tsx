...
const SkillCard = ({ icon, title, skills }: { icon: React.ReactNode, title: string, skills: string[] }) => (
  <div className="rounded-xl p-6 flex flex-col gap-4 min-w-[280px]  bg-[#23272f] shadow-[0px_0px_8px_0px_rgba(248,248,248,0.25)_inset,0px_32px_24px_-16px_rgba(0,0,0,0.10)]">
    ...
    <div className="flex flex-wrap gap-2">
      {skills.map(skill => (
        <span key={skill} className="flex items-center gap-2 bg-[#23272f] shadow-[0px_0px_8px_0px_rgba(248,248,248,0.25)_inset,0px_32px_24px_-16px_rgba(0,0,0,0.10)] text-gray-200 px-3 py-1 rounded-full text-sm font-medium border border-[#23263A]">
          {skillIconMap[skill] && (
            <span className="text-lg" style={{ color: skillIconMap[skill].color }}>
...
export default function SkillsSection(){
    ...
    return(
        <div id='skills' className="min-h-[40rem] rounded-md pt-40 bg-black flex flex-col items-center justify-center gap-10 relative w-full px-4 md:px-6 lg:px-8 xl:px-24">
            <motion.div
